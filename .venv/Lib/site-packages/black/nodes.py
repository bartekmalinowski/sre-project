...
def is_with_or_async_with_stmt(leaf: Leaf) -> bool:
    ...
    return bool(
        leaf.type == token.NAME and leaf.value == "with" and leaf.parent and leaf.parent.type == syms.with_stmt
    ) or bool(leaf.type == token.ASYNC and leaf.next_sibling and leaf.next_sibling.type == syms.with_stmt)
